...
const buttonClass =
  "inline-flex min-h-11 shrink-0 items-center justify-center whitespace-nowrap rounded-md px-3 text-sm font-semibold";

/**
 * Server-rendered from an already-resolved `authState` — no client-side auth check, no flicker.
 * Hidden below `2xl`: at that width `MobileNav`'s drawer carries the same actions instead, so the
